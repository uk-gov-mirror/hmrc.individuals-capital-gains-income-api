...
class Def2_RetrieveNonPpdResidentialPropertyCgtValidatorSpec extends UnitSpec {
  ...
  "running a validation" should {
    "return no errors" when {
      "a valid request is supplied" in {
        ...
        result shouldBe Right(Def2_RetrieveNonPpdResidentialPropertyRequestData(parsedNino, parsedTaxYear))
      }
    }
