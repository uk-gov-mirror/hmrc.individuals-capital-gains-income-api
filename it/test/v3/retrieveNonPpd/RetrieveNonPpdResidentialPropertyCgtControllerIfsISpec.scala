...
class RetrieveNonPpdResidentialPropertyCgtControllerIfsISpec extends IntegrationBaseSpec {
  ...
  private trait Test {
    ...
    val downstreamResponse: JsValue = Json.toJson(Def1_RetrieveNonPpdResidentialPropertyCgtControllerFixture.downstreamJson)
